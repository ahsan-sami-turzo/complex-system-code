...
Globals [previous-circular-mean]

to setup

  set previous-circular-mean 0
...
to go
  ...
  let current-circular-mean circular-mean
  if abs (current-circular-mean - previous-circular-mean) < 0.01 [ stop ]
  set previous-circular-mean current-circular-mean
  ...
  set-current-plot "Max Heading"
  plot max [heading] of turtles

  set-current-plot "Min Heading"
  plot min [heading] of turtles

  set-current-plot "Circular Mean"
  plot circular-mean

  set-current-plot "Max Circular Mean to Zero"
  plot max map circular-mean-to-zero [heading] of turtles

  set-current-plot "Min Circular Mean to Zero"
  plot min map circular-mean-to-zero [heading] of turtles
...
to-report circular-mean
  let sum-of-sin sum map sin [heading] of turtles
  let sum-of-cos sum map cos [heading] of turtles
  report atan sum-of-sin sum-of-cos
end

to-report circular-mean-to-zero [h]
  report ((h - circular-mean - 180) mod 360) - 180
end
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>circular-mean</metric>
    <steppedValueSet variable="vision" first="3" step="3" last="9"/>
    <steppedValueSet variable="max-align-turn" first="4" step="4" last="16"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
