...
to sierpinski-carpet
  ...
  set len 500
  sierpinski-carpet-command "t fd len t fd len t fd len rt 90 t fd len t fd len t fd len rt 90 t fd len t fd len t fd len rt 90 t fd len t fd len t fd len"
  iterate
end
