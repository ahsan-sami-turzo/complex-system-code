...
to hilbert-curve
  ...
  set len 200
  hilbert-command "lt 90 t fd len rt 90 t fd len lt 90 t fd len rt 90 t fd len"
  iterate
end

to hilbert-command [hilbert-command-string]
  set angle 90
  set scale-factor 1 / 2
  set memory (word memory "\n" hilbert-command-string)
  set len len / 2
  tick
end
...
to peano-curve
  ...
  set len 500
  peano-command "lt 90 t fd len rt 90 t fd len lt 90 t fd len rt 90 t fd len lt 90 t fd len rt 90 t fd len"
  iterate
end

to peano-command [peano-command-string]
  set angle 90
  set scale-factor 1 / 3
  set memory (word memory "\n" peano-command-string)
  set len len / 3
  tick
end


to sierpinski-carpet
  reset
  set fractal-length 1
  set fractal-name "sierpinski-carpet"
  set n-rep 8
  ask turtles[
    set pen-size 2
    pen-up
  ...
  set len 500
  sierpinski-carpet-command "t fd len t fd len t fd len rt 90 t fd len t fd len t fd len rt 90 t fd len t fd len t fd len"
  iterate
end

to sierpinski-carpet-command [sierpinski-carpet-command-string]
  set angle 90
  set scale-factor 1 / 3
  set memory (word memory "\n" sierpinski-carpet-command-string)
  set len len / 3
  tick
end
...
to calc-length
  ...
  if fractal-name = "hilbert" [set fractal-length fractal-length * 4 / 2]
  if fractal-name = "peano" [set fractal-length fractal-length * 9 / 3]
  if fractal-name = "sierpinski-carpet" [set fractal-length fractal-length * 8 / 3]
end
@#$#@#$#@
GRAPHICS-WINDOW
262
